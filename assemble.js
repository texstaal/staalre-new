...
body = body.replace(/<a [^>]*class="footer_social-link__2uQBq"[^>]*>\s*Linkedin\s*<\/a>/,
  ...
  '<a href="' + WA_HREF + '" target="_blank" rel="noopener noreferrer" aria-label="Message us on WhatsApp" style="display:inline-flex;align-items:center;gap:.6rem;padding:.7rem 1.5rem;border-radius:999px;background:#fff;color:#151717;font-weight:600;font-size:1.6rem;line-height:1.5;text-decoration:none"><svg viewBox="0 0 24 24" width="18" height="18" fill="currentColor" aria-hidden="true" style="flex:none"><path d="' + WA_PATH + '"></path></svg>WhatsApp</a>');
